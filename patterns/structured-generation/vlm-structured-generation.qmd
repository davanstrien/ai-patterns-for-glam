...
The dataset is available in Parquet format on [Hugging Face](https://huggingface.co/datasets/biglam/sloane-catalogues) so it can be easily loaded using the `datasets` library.
